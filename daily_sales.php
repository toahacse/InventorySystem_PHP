    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-bordered table-striped" id="daily-sales-table">
            <thead>
              <tr>
    ...
    searchDataTable();
      $(document).on("click","#export_as_excel",function(){
          if(confirm("Are You Want To Export It as a Excel ?")){
              html_table_to_excel('xlsx', 'Daily Sales');
          }
      });
      ...
      {
          var data = document.getElementById('daily-sales-table');
  ...
  function searchDataTable(){
    $(document).ready(function () {
        ...
        $('#daily-sales-table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#daily-sales-table thead');
        ...
        $(document).find('#daily-sales-table_filter').hide();
    });
  }
