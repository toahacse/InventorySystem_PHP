    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-bordered table-striped" id="monthly-sales-table">
            <thead>
              <tr>
...
<script>
  searchDataTable();
      $(document).on("click","#export_as_excel",function(){
          if(confirm("Are You Want To Export It as a Excel ?")){
              html_table_to_excel('xlsx', 'Monthly Sales');
          }
      });
      ...
      {
          var data = document.getElementById('monthly-sales-table');
  ...
  function searchDataTable(){
    $(document).ready(function () {
        ...
        $('#monthly-sales-table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#monthly-sales-table thead');
        ...
        $(document).find('#monthly-sales-table_filter').hide();
    });
  }
