...
<?php
 $year  = date('Y');
 $month = date('m');
 $sales = dailyPurchase($year,$month);
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-bordered table-striped" id="daily-purchase-table">
            <thead>
              <tr>
...
<script>
  ...
  searchDataTable();
      ...
      {
          var data = document.getElementById('daily-purchase-table');
  ...
  function searchDataTable(){
    $(document).ready(function () {
        ...
        $('#daily-purchase-table thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#daily-purchase-table thead');
    
        var table = $('#daily-purchase-table').DataTable({
            orderCellsTop: true,
            fixedHeader: true,
        ...
        $(document).find('#daily-purchase-table_filter').hide();
    });
  }
</script>